...
function setPageDimensions(dimensions){
    ...
    var reserved_h_top = 110;
    var reserved_h_bottom = 5;
    var reserved_w_left = 60;
    var reserved_w_right = 60;
    ...
    if(width<$(window).width()){
        $('#secondbody').width($(window).width());
    }else{
        $('#secondbody').width(width);
    }
    if(height<$(window).height()){
        $('#secondbody').height($(window).height());
    }else{
        $('#secondbody').height(height);
    }


    $('#appholder').width(width);
